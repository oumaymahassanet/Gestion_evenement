...
<form action='<?php echo base_url();?>user/add_organizer2' method="post">
  <div class="form-group">
    ...
    <label for="exampleInputEmail1">Description</label>
       <input type="texte" class="form-control" id="description" name="description" >
        ...
        <input type="texte" class="form-control" id="adress" name="adress"  required="required">
       ...
       <input type="texte" class="form-control" id="zip" name="zip"  >
    ...
    <label for="exampleInputVille">Ville</label>
       ...
       <input type="texte" class="form-control" id="phone2" name="phone2" placeholder='+216' >
       <label for="exampleInputEmail1">Fax</label>
       <input type="texte" class="form-control" id="fax" name="fax" placeholder='+216' >
